...
extension GetItInjectableX on _i1.GetIt {
  _i1.GetIt init({
    ...
    gh.factory<BeginTestRepository>(
            () => BeginTestRepositoryImpl(testDataSource: gh<TestDataSource>()));
    gh.factory<BeginTestUseCase>(
            () => BeginTestUseCase(beginTestRepository: gh<BeginTestRepository>()));

    gh.factory<FinishTestUseCase>(
            () => FinishTestUseCase(beginTestRepository: gh<BeginTestRepository>()));
    ...
    gh.factory<NextTestUseCase>(
            () => NextTestUseCase(beginTestRepository: gh<BeginTestRepository>()));

    gh.factory<NextTestBloc>(() => NextTestBloc(
